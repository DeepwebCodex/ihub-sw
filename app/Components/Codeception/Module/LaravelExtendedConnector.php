...
class LaravelExtendedConnector extends Client
{
    /**
     * @var Application
     */
    ...
    public function __construct($module)
    {
        ...
        if($this->module->config['server']){
            $server = array_merge(['HTTP_HOST' => $host], $this->module->config['server']);
        }

        parent::__construct($this->app, $server);
