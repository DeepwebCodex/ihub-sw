 ...
 */
class WithdrawAndDepositRequest extends BaseEgtRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'PartnerId' => 'bail|required|integer|nullable',
            'CashdeskId' => 'bail|required|integer|nullable',
            'UserIp'    => 'bail|required|string|nullable'
        ];
    }
}
